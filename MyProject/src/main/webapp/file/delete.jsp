...
<%
	...
	//삭제할 파일의 전체 경로를 이용해서 File 객체를 생성 후 해당 파일 삭제하기
	...
	response.sendRedirect(cPath+"/file/list.jsp"); //파일 목록 보기로 다시 리다이렉트
%>    
